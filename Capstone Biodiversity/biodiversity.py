...
number_species = species.nunique()
...
conservation_status_summmary = species.scientific_name.groupby(species.conservation_status).count()
print conservation_status_summmary
...
sheep_results = species[species.is_sheep.isin(['True'])]
print sheep_results
...
sheep_species = sheep_results[sheep_results.category.isin(['Mammal'])]
print sheep_species
...
plt.savefig('sheep per week.png')
plt.show()
...
obs_by_park['weeks_to_get_sample'] = sample_sheep_size/obs_by_park['observations']
print obs_by_park
